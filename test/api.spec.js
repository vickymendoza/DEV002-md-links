...
test('test for validatelinks link invalido', () => {
  ...
  const esperado_valido = JSON.parse('{"text":"md-links","href":"https://ouser-images.githubusercontent.com//110297//42118443-b7a5f1f0-7bc8-11e8-96ad-9cc5593715a6.jpg","path":"C:\\\\Users\\\\Victoria\\\\Desktop\\\\mdLinksDos\\\\DEV002-md-links\\\\newReadme.md","status":500,"ok":"Domain Not Found"}');  
  return expect(validatelinks(objetoIniciaL_valido)).resolves.toStrictEqual(esperado_valido);
});

test('test for validatelinks link ok', () => {
  const objetoIniciaL_valido = JSON.parse('{"text":"Arreglos","href":"https://curriculum.laboratoria.la//es//topics//javascript//04-arrays","path":"C:\\\\Users\\\\Victoria\\\\Desktop\\\\mdLinksDos\\\\DEV002-md-links\\\\newReadme.md"}');
  const esperado_valido = JSON.parse('{"text":"Arreglos","href":"https://curriculum.laboratoria.la//es//topics//javascript//04-arrays","path":"C:\\\\Users\\\\Victoria\\\\Desktop\\\\mdLinksDos\\\\DEV002-md-links\\\\newReadme.md","status":200,"ok":"OK"}');
  return expect(validatelinks(objetoIniciaL_valido)).resolves.toStrictEqual(esperado_valido);
});
